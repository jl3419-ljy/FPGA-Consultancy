...
extern "C" void example_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
...
((hls::stream<char>*)__xlx_apatb_param_A_V_data_V)->read();
((hls::stream<char>*)__xlx_apatb_param_A_V_keep_V)->read();
((hls::stream<char>*)__xlx_apatb_param_A_V_strb_V)->read();
((hls::stream<char>*)__xlx_apatb_param_A_V_user_V)->read();
((hls::stream<char>*)__xlx_apatb_param_A_V_last_V)->read();
((hls::stream<char>*)__xlx_apatb_param_A_V_id_V)->read();
((hls::stream<char>*)__xlx_apatb_param_A_V_dest_V)->read();
}
{unsigned xlx_stream_B_size = 0;

          std::vector<sc_bv<8> > B_V_data_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<8> > B_V_data_V_pc_buffer;
          int i = 0;
...
B_V_data_V_pc_buffer_Copy=B_V_data_V_pc_buffer;
          ...
          std::vector<sc_bv<8> > B_V_keep_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<8> > B_V_keep_V_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
...
B_V_keep_V_pc_buffer_Copy=B_V_keep_V_pc_buffer;
          ...
          std::vector<sc_bv<8> > B_V_strb_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<8> > B_V_strb_V_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
...
B_V_strb_V_pc_buffer_Copy=B_V_strb_V_pc_buffer;
          ...
          std::vector<sc_bv<8> > B_V_user_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(AUTOTB_TVOUT_PC_B_V_user_V);
        if (rtl_tv_out_file.good()) {
          rtl_tv_out_file >> AESL_token;
          if (AESL_token != "[[[runtime]]]")
            exit(1);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<8> > B_V_user_V_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
          ...
          if (i > 0) {xlx_stream_B_size=B_V_user_V_pc_buffer.size();
B_V_user_V_pc_buffer_Copy=B_V_user_V_pc_buffer;
}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
  
          std::vector<sc_bv<8> > B_V_last_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<8> > B_V_last_V_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
...
B_V_last_V_pc_buffer_Copy=B_V_last_V_pc_buffer;
          ...
          std::vector<sc_bv<8> > B_V_id_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(AUTOTB_TVOUT_PC_B_V_id_V);
        if (rtl_tv_out_file.good()) {
          rtl_tv_out_file >> AESL_token;
          if (AESL_token != "[[[runtime]]]")
            exit(1);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<8> > B_V_id_V_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
          ...
          if (i > 0) {xlx_stream_B_size=B_V_id_V_pc_buffer.size();
B_V_id_V_pc_buffer_Copy=B_V_id_V_pc_buffer;
}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
  
          std::vector<sc_bv<8> > B_V_dest_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(AUTOTB_TVOUT_PC_B_V_dest_V);
        if (rtl_tv_out_file.good()) {
          rtl_tv_out_file >> AESL_token;
          if (AESL_token != "[[[runtime]]]")
            exit(1);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<8> > B_V_dest_V_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
          ...
          if (i > 0) {xlx_stream_B_size=B_V_dest_V_pc_buffer.size();
B_V_dest_V_pc_buffer_Copy=B_V_dest_V_pc_buffer;
}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
...
((char*)&xlx_stream_elt_data)[0] = B_V_data_V_pc_buffer_Copy[j].to_int64();
((hls::stream<char>*)__xlx_apatb_param_B_V_data_V)->write(xlx_stream_elt_data);
char xlx_stream_elt_keep;
((char*)&xlx_stream_elt_keep)[0] = B_V_keep_V_pc_buffer_Copy[j].to_uint64();
((hls::stream<char>*)__xlx_apatb_param_B_V_keep_V)->write(xlx_stream_elt_keep);
char xlx_stream_elt_strb;
((char*)&xlx_stream_elt_strb)[0] = B_V_strb_V_pc_buffer_Copy[j].to_uint64();
((hls::stream<char>*)__xlx_apatb_param_B_V_strb_V)->write(xlx_stream_elt_strb);
char xlx_stream_elt_user;
((char*)&xlx_stream_elt_user)[0] = B_V_user_V_pc_buffer_Copy[j].to_int64();
((hls::stream<char>*)__xlx_apatb_param_B_V_user_V)->write(xlx_stream_elt_user);
...
((char*)&xlx_stream_elt_id)[0] = B_V_id_V_pc_buffer_Copy[j].to_int64();
((hls::stream<char>*)__xlx_apatb_param_B_V_id_V)->write(xlx_stream_elt_id);
char xlx_stream_elt_dest;
((char*)&xlx_stream_elt_dest)[0] = B_V_dest_V_pc_buffer_Copy[j].to_int64();
((hls::stream<char>*)__xlx_apatb_param_B_V_dest_V)->write(xlx_stream_elt_dest);
}}
...
// data
std::vector<char> __xlx_apatb_param_A_V_data_V_stream_buf;
{
  while (!((hls::stream<char>*)__xlx_apatb_param_A_V_data_V)->empty())
    __xlx_apatb_param_A_V_data_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_A_V_data_V)->read());
  for (int i = 0; i < __xlx_apatb_param_A_V_data_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_A_V_data_V)->write(__xlx_apatb_param_A_V_data_V_stream_buf[i]);
  }
long __xlx_apatb_param_A_stream_buf_size = ((hls::stream<char>*)__xlx_apatb_param_A_V_data_V)->size();
// keep
std::vector<char> __xlx_apatb_param_A_V_keep_V_stream_buf;
{
  while (!((hls::stream<char>*)__xlx_apatb_param_A_V_keep_V)->empty())
    __xlx_apatb_param_A_V_keep_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_A_V_keep_V)->read());
  for (int i = 0; i < __xlx_apatb_param_A_V_keep_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_A_V_keep_V)->write(__xlx_apatb_param_A_V_keep_V_stream_buf[i]);
  }
// strb
std::vector<char> __xlx_apatb_param_A_V_strb_V_stream_buf;
{
  while (!((hls::stream<char>*)__xlx_apatb_param_A_V_strb_V)->empty())
    __xlx_apatb_param_A_V_strb_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_A_V_strb_V)->read());
  for (int i = 0; i < __xlx_apatb_param_A_V_strb_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_A_V_strb_V)->write(__xlx_apatb_param_A_V_strb_V_stream_buf[i]);
  }
// user
std::vector<char> __xlx_apatb_param_A_V_user_V_stream_buf;
{
  while (!((hls::stream<char>*)__xlx_apatb_param_A_V_user_V)->empty())
    __xlx_apatb_param_A_V_user_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_A_V_user_V)->read());
  for (int i = 0; i < __xlx_apatb_param_A_V_user_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_A_V_user_V)->write(__xlx_apatb_param_A_V_user_V_stream_buf[i]);
  }
// last
...
// id
std::vector<char> __xlx_apatb_param_A_V_id_V_stream_buf;
{
  while (!((hls::stream<char>*)__xlx_apatb_param_A_V_id_V)->empty())
    __xlx_apatb_param_A_V_id_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_A_V_id_V)->read());
  for (int i = 0; i < __xlx_apatb_param_A_V_id_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_A_V_id_V)->write(__xlx_apatb_param_A_V_id_V_stream_buf[i]);
  }
// dest
std::vector<char> __xlx_apatb_param_A_V_dest_V_stream_buf;
{
  while (!((hls::stream<char>*)__xlx_apatb_param_A_V_dest_V)->empty())
    __xlx_apatb_param_A_V_dest_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_A_V_dest_V)->read());
  for (int i = 0; i < __xlx_apatb_param_A_V_dest_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_A_V_dest_V)->write(__xlx_apatb_param_A_V_dest_V_stream_buf[i]);
  }
// data
std::vector<char> __xlx_apatb_param_B_V_data_V_stream_buf;
long __xlx_apatb_param_B_stream_buf_size = ((hls::stream<char>*)__xlx_apatb_param_B_V_data_V)->size();
// keep
std::vector<char> __xlx_apatb_param_B_V_keep_V_stream_buf;
// strb
std::vector<char> __xlx_apatb_param_B_V_strb_V_stream_buf;
// user
std::vector<char> __xlx_apatb_param_B_V_user_V_stream_buf;
// last
std::vector<char> __xlx_apatb_param_B_V_last_V_stream_buf;
// id
std::vector<char> __xlx_apatb_param_B_V_id_V_stream_buf;
// dest
std::vector<char> __xlx_apatb_param_B_V_dest_V_stream_buf;
...
long __xlx_apatb_param_A_stream_buf_final_size = __xlx_apatb_param_A_stream_buf_size - ((hls::stream<char>*)__xlx_apatb_param_A_V_data_V)->size();
...
aesl_fh.write(AUTOTB_TVIN_A_V_user_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_A_V_last_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_A_V_id_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_A_V_dest_V, begin_str(AESL_transaction));
for (int i = 0; i < __xlx_apatb_param_A_stream_buf_final_size; ++i) {
  std::string s;
s = formatData((unsigned char*)(__xlx_apatb_param_A_V_data_V_stream_buf.data()+i), 8);
aesl_fh.write(AUTOTB_TVIN_A_V_data_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_A_V_keep_V_stream_buf.data()+i), 1);
aesl_fh.write(AUTOTB_TVIN_A_V_keep_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_A_V_strb_V_stream_buf.data()+i), 1);
aesl_fh.write(AUTOTB_TVIN_A_V_strb_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_A_V_user_V_stream_buf.data()+i), 2);
aesl_fh.write(AUTOTB_TVIN_A_V_user_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_A_V_last_V_stream_buf.data()+i), 1);
aesl_fh.write(AUTOTB_TVIN_A_V_last_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_A_V_id_V_stream_buf.data()+i), 5);
aesl_fh.write(AUTOTB_TVIN_A_V_id_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_A_V_dest_V_stream_buf.data()+i), 6);
aesl_fh.write(AUTOTB_TVIN_A_V_dest_V, s);
}
...
aesl_fh.write(AUTOTB_TVIN_A_V_user_V, end_str());
...
aesl_fh.write(AUTOTB_TVIN_A_V_id_V, end_str());
tcl_file.set_num(__xlx_apatb_param_A_stream_buf_final_size, &tcl_file.A_V_dest_V_depth);
aesl_fh.write(AUTOTB_TVIN_A_V_dest_V, end_str());
...
// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_A_V_user_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_A_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_A_V_user_V, end_str());
}
...
// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_A_V_id_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_A_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_A_V_id_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_A_V_dest_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_A_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_A_V_dest_V, end_str());
}
{
...
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_A_V_user_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_A_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_A_V_user_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_A_V_user_V, end_str());
}
{
...
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_A_V_id_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_A_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_A_V_id_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_A_V_id_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_A_V_dest_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_A_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_A_V_dest_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_A_V_dest_V, end_str());
}

//********************** dump C output stream *******************
long __xlx_apatb_param_B_stream_buf_final_size = ((hls::stream<char>*)__xlx_apatb_param_B_V_data_V)->size() - __xlx_apatb_param_B_stream_buf_size;
{
  while (!((hls::stream<char>*)__xlx_apatb_param_B_V_data_V)->empty())
    __xlx_apatb_param_B_V_data_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_B_V_data_V)->read());
  for (int i = 0; i < __xlx_apatb_param_B_V_data_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_B_V_data_V)->write(__xlx_apatb_param_B_V_data_V_stream_buf[i]);
  }
{
...
{
  while (!((hls::stream<char>*)__xlx_apatb_param_B_V_user_V)->empty())
    __xlx_apatb_param_B_V_user_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_B_V_user_V)->read());
  for (int i = 0; i < __xlx_apatb_param_B_V_user_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_B_V_user_V)->write(__xlx_apatb_param_B_V_user_V_stream_buf[i]);
  }
{
...
{
  while (!((hls::stream<char>*)__xlx_apatb_param_B_V_id_V)->empty())
    __xlx_apatb_param_B_V_id_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_B_V_id_V)->read());
  for (int i = 0; i < __xlx_apatb_param_B_V_id_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_B_V_id_V)->write(__xlx_apatb_param_B_V_id_V_stream_buf[i]);
  }
{
  while (!((hls::stream<char>*)__xlx_apatb_param_B_V_dest_V)->empty())
    __xlx_apatb_param_B_V_dest_V_stream_buf.push_back(((hls::stream<char>*)__xlx_apatb_param_B_V_dest_V)->read());
  for (int i = 0; i < __xlx_apatb_param_B_V_dest_V_stream_buf.size(); ++i)
    ((hls::stream<char>*)__xlx_apatb_param_B_V_dest_V)->write(__xlx_apatb_param_B_V_dest_V_stream_buf[i]);
  }
...
aesl_fh.write(AUTOTB_TVOUT_B_V_user_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVOUT_B_V_last_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVOUT_B_V_id_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVOUT_B_V_dest_V, begin_str(AESL_transaction));
for (int i = 0; i < __xlx_apatb_param_B_stream_buf_final_size; ++i) {
  std::string s;
s = formatData((unsigned char*)(__xlx_apatb_param_B_V_data_V_stream_buf.data()+__xlx_apatb_param_B_stream_buf_size+i), 8);
aesl_fh.write(AUTOTB_TVOUT_B_V_data_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_B_V_keep_V_stream_buf.data()+__xlx_apatb_param_B_stream_buf_size+i), 1);
aesl_fh.write(AUTOTB_TVOUT_B_V_keep_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_B_V_strb_V_stream_buf.data()+__xlx_apatb_param_B_stream_buf_size+i), 1);
aesl_fh.write(AUTOTB_TVOUT_B_V_strb_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_B_V_user_V_stream_buf.data()+__xlx_apatb_param_B_stream_buf_size+i), 2);
aesl_fh.write(AUTOTB_TVOUT_B_V_user_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_B_V_last_V_stream_buf.data()+__xlx_apatb_param_B_stream_buf_size+i), 1);
aesl_fh.write(AUTOTB_TVOUT_B_V_last_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_B_V_id_V_stream_buf.data()+__xlx_apatb_param_B_stream_buf_size+i), 5);
aesl_fh.write(AUTOTB_TVOUT_B_V_id_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_B_V_dest_V_stream_buf.data()+__xlx_apatb_param_B_stream_buf_size+i), 6);
aesl_fh.write(AUTOTB_TVOUT_B_V_dest_V, s);
}
...
aesl_fh.write(AUTOTB_TVOUT_B_V_user_V, end_str());
...
aesl_fh.write(AUTOTB_TVOUT_B_V_id_V, end_str());
tcl_file.set_num(__xlx_apatb_param_B_stream_buf_final_size, &tcl_file.B_V_dest_V_depth);
aesl_fh.write(AUTOTB_TVOUT_B_V_dest_V, end_str());
{
...
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_B_V_user_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_B_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_B_V_user_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_B_V_user_V, end_str());
}
{
...
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_B_V_id_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_B_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_B_V_id_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_B_V_id_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_B_V_dest_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_B_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_B_V_dest_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_B_V_dest_V, end_str());
}
